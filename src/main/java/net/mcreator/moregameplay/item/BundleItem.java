...
import net.mcreator.moregameplay.gui.BundleguiGuiWindow;
import net.mcreator.moregameplay.gui.BundleguiGui;
...
public class BundleItem extends MoregameplayModElements.ModElement {
	@ObjectHolder("moregameplay:bundle")
	public static final Item block = null;
	public BundleItem(MoregameplayModElements instance) {
		super(instance, 3);
