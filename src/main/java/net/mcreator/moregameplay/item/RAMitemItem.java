...
public class RAMitemItem extends MoregameplayModElements.ModElement {
	@ObjectHolder("moregameplay:ra_mitem")
	public static final Item block = null;
	public RAMitemItem(MoregameplayModElements instance) {
		super(instance, 28);
	}
