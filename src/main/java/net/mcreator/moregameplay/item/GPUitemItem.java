...
public class GPUitemItem extends MoregameplayModElements.ModElement {
	@ObjectHolder("moregameplay:gp_uitem")
	public static final Item block = null;
	public GPUitemItem(MoregameplayModElements instance) {
		super(instance, 27);
	}
