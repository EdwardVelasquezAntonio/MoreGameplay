...
public class CPUitemItem extends MoregameplayModElements.ModElement {
	@ObjectHolder("moregameplay:cp_uitem")
	public static final Item block = null;
	public CPUitemItem(MoregameplayModElements instance) {
		super(instance, 26);
	}
