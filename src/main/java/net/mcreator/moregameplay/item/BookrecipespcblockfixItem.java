...
import net.mcreator.moregameplay.procedures.BookrecipespcblockfixRightClickedInAirProcedure;
import net.mcreator.moregameplay.itemgroup.MoreGameplayItemGroup;
import net.mcreator.moregameplay.gui.BookrecipespcfixedguiGuiWindow;
import net.mcreator.moregameplay.gui.BookrecipespcfixedguiGui;
...
public class BookrecipespcblockfixItem extends MoregameplayModElements.ModElement {
	@ObjectHolder("moregameplay:bookrecipespcblockfix")
	public static final Item block = null;
	public BookrecipespcblockfixItem(MoregameplayModElements instance) {
		super(instance, 34);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BookrecipespcfixedguiGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(MoreGameplayItemGroup.tab).maxStackSize(1).rarity(Rarity.UNCOMMON));
			setRegistryName("bookrecipespcblockfix");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Book Recipes of PC Fixed");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BookrecipespcfixedguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
			...
			}
			{
				...
				BookrecipespcblockfixRightClickedInAirProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
