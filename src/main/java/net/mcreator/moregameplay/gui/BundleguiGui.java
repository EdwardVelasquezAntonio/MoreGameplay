...
public class BundleguiGui extends MoregameplayModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public BundleguiGui(MoregameplayModElements instance) {
		super(instance, 3);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("bundlegui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 7, 31) {
			}));
			this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 25, 31) {
			}));
			this.customSlots.put(11, this.addSlot(new SlotItemHandler(internal, 11, 43, 31) {
			}));
			this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 61, 31) {
			}));
			this.customSlots.put(13, this.addSlot(new SlotItemHandler(internal, 13, 79, 31) {
			}));
			this.customSlots.put(14, this.addSlot(new SlotItemHandler(internal, 14, 97, 31) {
			}));
			this.customSlots.put(15, this.addSlot(new SlotItemHandler(internal, 15, 133, 63) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(Items.WATER_BUCKET, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(16, this.addSlot(new SlotItemHandler(internal, 16, 151, 63) {
				@Override
				public boolean isItemValid(ItemStack stack) {
