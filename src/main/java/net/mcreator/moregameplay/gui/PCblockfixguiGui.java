...
import net.mcreator.moregameplay.procedures.PCguiprocedure1Procedure;
...
public class PCblockfixguiGui extends MoregameplayModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public PCblockfixguiGui(MoregameplayModElements instance) {
		super(instance, 33);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("p_cblockfixgui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, PCblockfixguiGuiWindow::new));
	}
		...
		if (buttonID == 0) {
			{
				...
				PCguiprocedure1Procedure.executeProcedure($_dependencies);
			}
		}
	}
