...
public class BookrecipespcfixedguiGui extends MoregameplayModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public BookrecipespcfixedguiGui(MoregameplayModElements instance) {
		super(instance, 34);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("bookrecipespcfixedgui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, BookrecipespcfixedguiGuiWindow::new));
	}
